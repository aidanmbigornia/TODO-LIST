...
const de_CreateFunctionUrlConfigCommand = async (output, context) => {
    ...
    if (data.InvokeMode != null) {
        contents.InvokeMode = (0, smithy_client_1.expectString)(data.InvokeMode);
    }
    return contents;
};
...
const de_FunctionUrlConfig = (output, context) => {
    return {
        ...
        InvokeMode: (0, smithy_client_1.expectString)(output.InvokeMode),
...
const de_InvokeWithResponseStreamCompleteEvent = (output, context) => {
    return {
        ...
        LogResult: (0, smithy_client_1.expectString)(output.LogResult),
    };
};
